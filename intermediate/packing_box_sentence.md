**Title** Packing a Sentence in a Box
...
Your program should emit the starting position (1-indexed) for the sentence, and then the box with the sentence packed into it. Here's one possible solution:
